...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/weapons/wos_poolitemplacer/shared.lua
...
function SWEP:SecondaryAttack()
	if CLIENT then
		...
		for i=1, 9 do
			local l = vgui.Create( "DCheckBox", Options )
			l:SetSize( 16, 16 )
			...
			local l2 = vgui.Create( "DLabel", Options )
			l2:SetPos( posx, posy )
