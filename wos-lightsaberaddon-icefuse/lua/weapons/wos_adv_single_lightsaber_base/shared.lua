...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/weapons/wos_adv_single_lightsaber_base/shared.lua
...
function SWEP:Initialize()
	...
	self.SwingSound = self.SwingSound or "lightsaber/saber_swing" .. math.random( 1, 41 ) .. ".wav"
