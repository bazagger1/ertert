...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/weapons/wos_adv_single_lightsaber_base/cl_init.lua
...
function SWEP:DrawWorldModelTranslucent()
    ...
    if self:GetOwner():GetPos():Distance( LocalPlayer():GetPos() ) > wOS.LightsaberDrawDistance then return end
