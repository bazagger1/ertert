...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/wos/advswl/combat/cl_saberbase_hook.lua
...
hook.Add( "PostDrawOpaqueRenderables", "wOS.ForceHolograms", function()
