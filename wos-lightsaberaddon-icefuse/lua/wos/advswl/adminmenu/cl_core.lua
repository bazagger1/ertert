...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/wos/advswl/adminmenu/cl_core.lua
...
function wOS:OpenAdminMenu()
	...
	DataTab.PopulateTab = function( ply ) 
		...
		SLevel.Paint = function( pan, ww, hh )
			...
			draw.SimpleText( "SET LEVEL", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		SXP.Paint = function( pan, ww, hh )
			...
			draw.SimpleText( "SET XP", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		SKS.Paint = function( pan, ww, hh )
			draw.RoundedBox( 5, 0, 0, ww, hh, ( pan:IsDown() and Color( 0, 55, 155, 155 ) ) or Color( 155, 155, 155, 155 ) )
			draw.SimpleText( "SET POINTS", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		AddL.Paint = function( pan, ww, hh )
			draw.RoundedBox( 5, 0, 0, ww, hh, ( pan:IsDown() and Color( 0, 55, 155, 155 ) ) or Color( 155, 155, 155, 155 ) )
			draw.SimpleText( "ADD LEVEL", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		AddX.Paint = function( pan, ww, hh )
			draw.RoundedBox( 5, 0, 0, ww, hh, ( pan:IsDown() and Color( 0, 55, 155, 155 ) ) or Color( 155, 155, 155, 155 ) )
			draw.SimpleText( "ADD XP", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		AddSK.Paint = function( pan, ww, hh )
			draw.RoundedBox( 5, 0, 0, ww, hh, ( pan:IsDown() and Color( 0, 55, 155, 155 ) ) or Color( 155, 155, 155, 155 ) )
			draw.SimpleText( "ADD POINTS", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		ResetAll.Paint = function( pan, ww, hh )
			draw.RoundedBox( 5, 0, 0, ww, hh, ( pan:IsDown() and Color( 0, 55, 155, 155 ) ) or Color( 155, 155, 155, 155 ) )
			draw.SimpleText( "RESET ALL", "wOS.DescriptionFont", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
