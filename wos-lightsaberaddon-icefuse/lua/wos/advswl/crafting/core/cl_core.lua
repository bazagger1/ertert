...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/wos/advswl/crafting/core/cl_core.lua
...
language.Add( "wos_advert_wiltos", "Icefuse Store" )
...
language.Add( "wos_info_blueprints", "Blueprints" )
language.Add( "wos_info_miscitem", "Extensions" )
...
wOS.CraftingCamera = {}
wOS.CraftingCamera[ "Overview" ] = { origin = centerpoint - Vector( 380, -35, -25 ), angles = Angle( 20.840, -30.501, 0.000 ) }
...
wOS.CraftMenuLibrary[ "Overview" ] = function()
	...
	backbutt.Renders = function( pan )
		...
		local _jp, _pr, _hov = pan:Button( "Finish", "wOS.TitleFont", x, 1, ww, hh/8 )
	    if _jp then
