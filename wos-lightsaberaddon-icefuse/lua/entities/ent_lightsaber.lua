...
File Path:   addons/wos-lightsaberaddon-icefuse/lua/entities/ent_lightsaber.lua
...
function ENT:Initialize()
	...
	if ( SERVER ) then
		...
		self.SwingSound = self.SwingSound || "lightsaber/saber_swing" .. math.random( 1, 41 ) .. ".wav" -- was 1, 2
		...
		killicon.AddAlias( "ent_lightsaber", "weapon_lightsaber_wos" )
	end
end
