...
File Path:   addons/[weapons]_tfa_shared_menus_etc/lua/effects/effect_sw_impact_2/init.lua
...
-- function EFFECT:Think()
    -- if self:GetPos():Distance( LocalPlayer():EyePos() ) > 100 then return self.LifeTime > 0 end
