...
File Path:   addons/[weapons]_tfa_shared_menus_etc/lua/effects/effect_sw_laser_green/init.lua
...
function EFFECT:Think()
    ...
    if self:GetPos():Distance( LocalPlayer():EyePos() ) > 1024 then return self.LifeTime > 0 end
